      ...
      <aside class="shell__rail">
        ...
        <nav class="shell__nav" aria-label="Main navigation">
          ...
          <a
            ...
            routerLinkActive="shell__nav-item--active"
            #artifactsLink="routerLinkActive"
            class="shell__nav-item"
            [attr.aria-current]="artifactsLink.isActive ? 'page' : null"
            title="Artifacts"
          >
            <svg class="shell__nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="shell__nav-label">Artifacts</span>
          </a>
        </nav>
        <a
          routerLink="/settings"
          ...
          <div class="artifact-panel">
            <div class="artifact-panel__header">
              ...
              <div class="artifact-panel__actions">
                ...
                <button (click)="onDownloadArtifact()" title="Download" class="artifact-panel__action-btn">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export class AppShellComponent {
  ...
  onDownloadArtifact(): void {
    const artifact = this.artifactService.currentArtifact();
    if (artifact) {
      this.artifactService.downloadArtifact(artifact.id);
    }
  }
}
